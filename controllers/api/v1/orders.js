...
const get = (req, res) => {
  ...
  res.json({ message: `GET order with ID ${orderId}` });  // Gebruik backticks voor template literal
};
...
const update = (req, res) => {
  ...
  res.json({ message: `Order ${orderId} updated`, status });  // Gebruik backticks voor template literal
};
...
const remove = (req, res) => {
  ...
  res.json({ message: `Order ${orderId} deleted` });  // Gebruik backticks voor template literal
};
